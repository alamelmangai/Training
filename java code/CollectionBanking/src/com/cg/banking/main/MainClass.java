...
import com.cg.banking.exceptions.PayrollServicesDownExceptions;

public class MainClass {
	public static void main(String[] args) throws BankingServicesDownException, InvalidAmountException, CustomerNotFoundException, InvalidAccountTypeException, AccountNotFoundException, AccountBlockedException, InsufficientAmountException, InvalidPinNumberException {
		...
		do {
			...
			try {
				...
				case 9:
					...
					String statusCase9= bankingServies.accountStatus(customerIdCase9, accountNoCase9);
					System.out.println("Account Status : "+statusCase9);
					break;
				case 10:
					System.out.print("\t Enter CustomerID :  ");
...
BankingDAOServices bankingdaoservices=new BankingDAOServicesImpl();
		...
		System.out.println(bankingServices.acceptCustomerDetails("chinnu", "gopalan", "chinnu@gmail", "DFGRT2345", "Chennai", "tamilnadu", 45));
		System.out.println(bankingServices.acceptCustomerDetails("chijhgjknnu", "gopalan", "chinnu@gmail", "DFGRT2345", "Chennai", "tamilnadu", 45));
		System.out.println(bankingServices.openAccount(1, "savings", 2000));
		System.out.println(bankingServices.openAccount(2, "savings", 1000));
		System.out.println(bankingServices.openAccount(2, "current", 1000));
		System.out.println(bankingServices.depositAmount(2, 2, 3000));
		System.out.println(bankingServices.generateNewPin(2, 2));
		//System.out.println(bankingServices.getAccountDetails(2, 2).getAccountBalance());
		//System.out.println(bankingServices.changeAccountPin(2, 2, 1234, 4321));
		//System.out.println(bankingServices.withdrawAmount(2, 2, 500, 1234));
		//System.out.println(bankingServices.withdrawAmount(2, 2, 500, 1234));
		//System.out.println(bankingServices.closeAccount(2, 2));
		//System.out.println(bankingServices.depositAmount(2, 1, 1000));
		System.out.println(bankingServices.getAccountDetails(2, 2));
	}}