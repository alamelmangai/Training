...
public class Mainclass1{
	...
	//	System.out.println(payrollServices.acceptAssociateDetails( "Chinnu", "Dada","JAVA", "softwareEngg", "FGRS123", "deepak@gmail.com",30000, 2000, 2000, 123452, 60000, "CITI2341", "CITI"));
	//	System.out.println(payrollServices.deleteAssociate(118));
		System.out.println(payrollServices.updateAssociate(new Associate(new Salary(30000, 2000, 2000), new BankDetails(1324378623, "ICICI", "ICICI45"), 130, 65000, "aishwarya", "Patil", "SAP", "softwareEngg", "HGYTF213", "aishu@gmail.com")));
}}