...
public class Customer {
	...
	public Customer(String firstName, String lastName, String emailId, String panCard,
	...
	public Customer(int customerId, String firstName, String lastName, String emailId, String panCard,
			Address localAddress, Address homeAddress, Account[] accounts, long accountNoCounter,
			int accountNoIdxCounter) {
		super();
	...
	public String toString() {
		return "Customer [customerId=" + customerId + ", firstName=" + firstName + ", lastName=" + lastName
				...
				+ homeAddress + ", accounts=" + Arrays.toString(accounts) + ", accountNoIdxCounter="
				+ accountNoIdxCounter + "]";
	}
