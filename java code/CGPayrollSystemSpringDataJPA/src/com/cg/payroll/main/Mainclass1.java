...
public class Mainclass1{
	public static void main(String[] args) throws AssociateDetailsNotFoundExceptions, PayrollServicesDownExceptions{
		...
		/*try {
			...
			System.out.println(payrollServices.updateAssociate(new Associate(new Salary(30000, 2000, 2000), new BankDetails(132437, "ICICI", "ICICI45"), 4, 65000, "chinnu", "gopalan", "SAP", "softwareEngg", "HGYTF213", "chinnu@gmail.com")));
