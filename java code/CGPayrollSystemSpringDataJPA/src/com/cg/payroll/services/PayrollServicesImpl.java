...
public class PayrollServicesImpl implements PayrollServices {
	...
	public int acceptAssociateDetails(String firstName, String lastName, String department, String designation,
		...
		Associate associate = daoServices.save(new Associate(new Salary(basicSalary, epf, companyPf), new BankDetails(accountNumber, bankName, ifscCode), yearlyInvestmentUnder80C, firstName, lastName, department, designation, pancard, emailId));
