...
public class MainCLass {
	public static void main(String[] args) throws AssociateDetailsNotFoundExceptions {
		try {
			...
			int associateId1=payrollServices.acceptAssociateDetails("alamel", "mangai", "java", "software engg", "PJHY1234", "chinnu@gmail.com", 150000f, 20000f, 1000f, 1000f, 2346178, "HDFC", "HDFC12345");
			...
			System.out.println(payrollServices.deleteAssociate(associateId1));
			payrollServices.updateAssociate(new Associate(new Salary(25000, 3000, 3000), new BankDetails(2345982, "ICICI", "ICICI00234"), 111, 70000, "deepak", "Muraree", "Mainframe", "softwareengg", "DSDFG23L", "deepakpro@gmail.com"));
			System.out.println(payrollServices.getAssociateDetails(associateId1));
