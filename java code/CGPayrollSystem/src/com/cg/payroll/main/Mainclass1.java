	...
	public static void main(String[] args) throws PayrollServicesDownExceptions {
		try {
			...
			while(key!=7){
				...
				associateID= payrollServices.acceptAssociateDetails(firstName1, lastName1, department1, designation1, pancard1,  emailId1, yearlyInvestmentUnder80C1, basicSalary1, epf1, companyPf1, accountNumber1, bankName1, ifscCode1);
				System.out.println(payrollServices.getAssociateDetails(associateID));
				break;
