...
BankingDAOServices bankingdaoservices=new BankingDAOServicesImpl();
		...
		System.out.println(bankingServices.acceptCustomerDetails("priya", "gopalan", "chinnu@gmail", "DFGRT2345", "Chennai", "tamilnadu", 45));
		System.out.println(bankingServices.openAccount(1, "savings", 1000));
		System.out.println(bankingServices.openAccount(1, "current", 1000));
		System.out.println(bankingServices.depositAmount(1, 2, 3000));
		System.out.println(bankingServices.generateNewPin(1, 2));
		//System.out.println(bankingServices.depositAmount(2, 1, 1000));
		System.out.println(bankingServices.withdrawAmount(1, 2, 500, 1234));
		//System.out.println(bankingServices.closeAccount(1, 2));
